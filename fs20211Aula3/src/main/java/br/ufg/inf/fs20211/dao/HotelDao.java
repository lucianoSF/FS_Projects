...
public class HotelDao {
	...
	public Hotel insert(Hotel hotel) throws HotelException {
		...
		try {
			...
			throw new HotelException("A��o inesperada! Nenhuma linha foi inserida.");
		}
	...
	public Hotel update(Hotel hotel) throws HotelException {
		try {
			...
			throw new HotelException("A��o inesperada! Nenhuma linha foi alterada.");
		}
	...
	public void delete(Hotel hotel) throws HotelException {
		...
		try {
			...
			throw new HotelException("A��o inesperada! Nenhuma linha foi exclu�da.");
		}
